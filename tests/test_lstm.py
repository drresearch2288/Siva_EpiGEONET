"""Tests for LSTM baseline."""
import pytest
import torch
from torch.utils.data import DataLoader
from epigeonet.models.baselines.lstm import LSTMBaseline
...
def test_lstm_forward_and_train():
    device = get_device()
    N = 6
    T = 12
    in_dim = 24
    ...
    model = LSTMBaseline(in_dim=in_dim, hidden=64, num_layers=2).to(device)
